...
import AerialViewImage from '../components/arielview.webp';

export default function Slide6View() {
  return (
    <div style={{...styles.screen, ...styles.whiteBg}}>
      <div style={styles.container}>
        {/* Main Title */}
        <h1 style={styles.overviewTitle}>AERIAL VIEW OF PROPOSED SITE</h1>
        ...
        <div style={{ display: 'flex' }}>
          ...
          <div style={{ flex: '1', marginRight: '32px' }}>
            ...
            <img src={AerialViewImage} alt="Aerial View" style={{ width: '350px', height: '350px', objectFit: 'cover' }} />
          </div>
        ...
        {/* Page Number */}
        <div style={styles.overviewPageNumber}>05</div>
      </div>
    </div>
  );
}